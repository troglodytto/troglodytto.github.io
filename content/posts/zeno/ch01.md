...
Zig is interesting. It does tick most of the boxes that C and C++ do. On top of that, it has the added benefit of being very explicit, and having a lot of niceties over C/C++ without compromising anything meaningful, such as comptime, explicit allocations, state of the art error handling.

What about Rust?
Of course it does have the same benefits as the other options.
