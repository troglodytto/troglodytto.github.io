...
1. A kernel that can boot (_duh!_)
...
Most of you _already_ have a bunch of ideas in mind.

Perhaps C, or C++, Zig or Rust. Assembly? Nim?

Java?? Yes, People _have_ built operating systems in Java (Although the HALs were written in C/C++. Anyway, I digress)
...
What about Rust?
It has the same benefits as the other options. But additionally, I like the sound of zero cost abstractions. Of a compiler that gently guides me.

Rust also has a strong ecosystem which on the other hand, Zig does not (not yet at least).
That extends to tooling, debugging support, and stability (in terms of breaking changes in the language itself)
...
[Next: Leaving Kernel Dependencies behind]({{< ref "/posts/zeno/ch02.md" >}})
