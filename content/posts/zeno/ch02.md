...
In the [previous post]({{< ref "/posts/zeno/ch01.md" >}}) we settled on using Rust to write our OS so we'll set up a new rust application.
...
>...
>[[bin]]
>name = "zeno" # the name of our crate
>test = false # tell cargo to not compile tests
>bench = false # tell cargo to not compile benches
>...
>```
...
[Next: Booting into our kernel]({{< ref "/posts/zeno/ch03.md" >}})
