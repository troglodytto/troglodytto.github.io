...
In the [last post]({{< ref "/posts/zeno/ch02.md" >}}), we managed to create a rust binary that is independent of any OS dependencies
...
The [Intel® 64 and IA-32 Architectures Software Developer's Manual](https://www.intel.com/content/www/us/en/developer/articles/technical/intel-sdm.html) states (on Page 3455):
...
You can either copy this code as is, or head on over to this post [👉 Minimal MBR in Assembly]({{< ref "/posts/zeno/minimal-mbr-in-assembly.md" >}}) for more details
...
[Next: Integrating a concrete, battle tested bootloader]({{< ref "/posts/zeno/ch04.md" >}})
